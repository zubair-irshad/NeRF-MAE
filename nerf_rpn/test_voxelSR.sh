...
--save_path "/wild6d_data/zubair/nerf_mae/results/${dataset_name}_voxelSR_pretrain_384_old" \
--checkpoint "/wild6d_data/zubair/nerf_mae/results/${dataset_name}_voxelSR_pretrain_384_old/model_best.pt" \
--use_pretrained_model
# --save_path "/wild6d_data/zubair/nerf_mae/results/${dataset_name}_voxelSR_swinmae_1k_1515_0.75_clr_mrmvrgb_384_pretrain_500" \
