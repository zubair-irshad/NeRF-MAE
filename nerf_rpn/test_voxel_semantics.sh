...
--rot_scale_prob 0.0 \
--rotate_prob 0.0 \
--save_path "nerf_mae/results/${dataset_name}_voxelSem_3.5k_0.75_skip_weightedce_NOPT" \
--checkpoint "nerf_mae/results/${dataset_name}_voxelSem_3.5k_0.75_skip_weightedce_NOPT/model_best.pt" \
